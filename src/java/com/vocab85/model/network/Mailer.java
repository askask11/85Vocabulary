...
public class Mailer
{
    ...
    {
        Setting creds = new Setting("mail.setting");
        sendEmail(creds.get("host"), creds.get("port"), creds.get("user"), creds.get("pass"), recipient, subject, content);
    ...
    public static void main(String[] args)
    {
        try
        {
            sendDefaultMail("xeduoover18@gmail.com", "miao", "this is a miao mail.");
