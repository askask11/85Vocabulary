 ...
 * Description Of This Class: Generating Bootstrap Alerts.
 */
package com.vocab85.model;

/**
 * This class is created for generating HTML Bootstrap 4 alerts.
 *
 * @author Jianqing Gao
 */
public class BSAlerts
{
    ...
    {
        return "<div class=\"alert alert-info alert-dismissible\" style=\"margin-bottom:0px;\">\n"
                + "  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" style=\"margin-bottom:0px;\">&times;</button>\n"
                + "  <strong>" + title + "</strong> " + message + "\n"
                + "</div>";
    }
