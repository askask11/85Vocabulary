    ...
    <body onload="checkPage();">
        ...
        <div class="container text-center">
                        ...
                        <div id="editpanel" class="hidden">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-3 np">
                                    <button id="conf10" class="btn btn-primary" title="更换你的小码短链接API Key" onclick="editXiaomarkApi();">确认</button>
                                </div><br>
                            </div>
                            <br>
                            ...
                            <button id="delbtn" title="这里可以永久性删除你的账户" class="btn btn-danger" onclick="document.getElementById('popup2trigger').click();notify('这将会永久注销你的账号，所有数据将会<u>不可逆</u>地被擦除，确认要继续吗？');">
                                删除
                            </button>
            ...
            <div id="popup2" class="overlay">
                <div class="popup" style="margin: 140px auto; ">
                    <h2 id="ts11">确定删除账户？</h2>
                    <a class="close" href="#">&times;</a>
                    <div class="content">
                        <br><strong style="color:red;" id="ts12">
                            警告！此操作不可逆转
                        </strong>
                        <span id="ts13">这将会永久和BMC Account说拜拜，确认要继续吗？</span><br><br>
                        <button id="cancelbtn1" title="取消并返回" class="btn btn-success" onclick="document.getElementById('p1trigger').click();notify('很好~欢迎━(*｀∀´*)ノ亻!继续使用85Vocab.com. 有疑问请右下角反馈哦！');">
                            取消并返回编辑
                        </button>
                        <!--write method for continue delete account-->
                        <button id="ts14" title="不可反悔，确定吗？" class="btn btn-danger" >
                            继续
                        </button>
                    </div>
                </div>
            ...
            <div class="text-center hidden" id="waitingdiv">
                <span id="waitmsgg">请稍后， 正在为您生成错题本<br><br>
                    约需一分钟左右。</span>
        ...
        <script>
            makeTranslator("RequestFQuestion");
        </script>
    </body>
</html>
